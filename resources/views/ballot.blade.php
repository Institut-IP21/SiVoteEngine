...
<div class="container mx-auto">
    ...
    <form class="max-w-md mx-auto" action="/election/{{ $ballot->election->id }}/ballot/{{ $ballot->id }}" method="post">
        @csrf
        <div class="mt-3 rounded overflow-hidden shadow mx-auto">
            <div class="px-6 py-4">
                ...
                <input name="code" readonly class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none" id="code" type="text" placeholder="Koda" value="{{ $code }}">
            </div>
        </div>
